...
@section('content')
    <form action="/register" method="POST">
        ...
        <div class="form-floating mb-3">
            <input type="password" placeholder="name@example.com" name="password" class="form-control" id="exampleInputPassword1">
            <label for="exampleInputPassword1" class="form-label">Password</label>
        </div>
        <div class="form-floating mb-3">
            <input type="password" placeholder="name@example.com" name="password_confirmation" class="form-control" id="exampleInputPassword1">
